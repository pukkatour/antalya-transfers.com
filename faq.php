...
<a class="btn btn-link-1" href="<?php echo $selectedlang['lang_url']; ?>frequently-asked-questions" title="<?php echo $sitesettings['site_name']; ?>"><?php echo $data['page_faq_button']; ?> <i class="fa fa-angle-right"></i></a>
</div>
</div>
