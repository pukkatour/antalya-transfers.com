...
$data = $Db->row("SELECT * FROM page_cancellation_policy WHERE page_lang_id = ?", array($site_lang));

$pagename = "İptal Politikası";
...
<link rel="alternate" href="<?php echo SITE_URL; ?>cancellation-policy" hreflang="en-US" />
