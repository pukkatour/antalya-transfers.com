...
<link rel="alternate" href="<?php echo SITE_URL; ?>customer-reviews" hreflang="en-US" />
...
<div class="pull-right"><?php if (!empty($reviews)) { paging($urlsettedTR); } ?></div>
</div>
...
<?php
function paging($urlsettedTR) {
global $num_rows;
global $page;
global $page_amount;

if (!empty($_GET['sayfa'])) { $pagniation_page = $_GET['sayfa']; } else { $pagniation_page = 1; }
...
if ($page != "0") {
echo '<li><a href="'.SITE_URL.$urlsettedTR."?sayfa=1".'">«</a></li>';
$prev = $page - 1;
echo '<li><a href="'.SITE_URL.$urlsettedTR."?sayfa=".$prev.'">Önceki</a></li><li><a href="#">...</a></li>';
}
for ( $counter = max($pagniation_page - 4, 0); $counter <= $page_amount; $counter += 1 ) {
$pagee = $counter + 1;
echo '<li class="'; if ($pagniation_page == $pagee) { echo "active"; } echo '"><a href="'.SITE_URL.$urlsettedTR."?sayfa=$pagee".'">'.$pagee.'</a></li>';
...
echo '<li><a href="#">...</a></li><li><a href="'.SITE_URL.$urlsettedTR."?sayfa=$next".'">Sonraki</a></li>';
}
echo '<li><a href="'.SITE_URL.$urlsettedTR."?sayfa=".($page_amount + 1).'">»</a></li>';
echo "</ul>";
}
...
echo '<li><a href="'.SITE_URL.$urlsettedTR."&amp;sayfa=1".'">«</a></li>';
$prev = $page - 1;
echo '<li><a href="'.SITE_URL.$urlsettedTR."&amp;sayfa=1".'">Önceki</a></li><li><a href="#">...</a></li>';
}
for ($counter = max($pagniation_page - 4, 0); $counter <= $page_amount; $counter += 1) {
$pagee = $counter + 1;
echo '<li class="'; if ($pagniation_page == $pagee) {echo "active";} echo '"><a href="'.SITE_URL.$urlsettedTR."&amp;sayfa=$pagee".'">'.$pagee.'</a></li>';
