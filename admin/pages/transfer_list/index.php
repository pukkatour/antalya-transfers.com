...
$data    = $Db->row("SELECT * FROM page_transfer_list WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Transfer Listesi Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Transfer Listesi Sayfası İçerik Düzenleme</h3>
</div>
