...
$data    = $Db->row("SELECT * FROM page_transfer WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Transfer Detay Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Transfer Detay Sayfası İçerik Düzenleme</h3>
</div>
