...
$data    = $Db->row("SELECT * FROM page_cancellation_policy WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">İptal Politikası Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">İptal Politikası Sayfası İçerik Düzenleme</h3>
</div>
