...
$data    = $Db->row("SELECT * FROM page_faq WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Sık Sorulan Sorular Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Sık Sorulan Sorular Sayfası İçerik Düzenleme</h3>
</div>
...
<textarea rows="3" class="form-control" name="page_main_title" required=""><?php echo $data['page_main_title']; ?></textarea>
</div>
</div>
