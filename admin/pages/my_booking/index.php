...
$data    = $Db->row("SELECT * FROM page_my_booking WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Rezervsayonum Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Rezervsayonum Sayfası İçerik Düzenleme</h3>
</div>
