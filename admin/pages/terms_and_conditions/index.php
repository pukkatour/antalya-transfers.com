...
$data    = $Db->row("SELECT * FROM page_terms_conditions WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Şartlar & Koşullar Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Şartlar & Koşullar Sayfası İçerik Düzenleme</h3>
</div>
