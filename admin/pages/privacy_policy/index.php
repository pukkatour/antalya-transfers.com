...
$data    = $Db->row("SELECT * FROM page_privacy WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Gizlilik Politikası Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Gizlilik Politikası Sayfası İçerik Düzenleme</h3>
</div>
