...
$data    = $Db->row("SELECT * FROM page_cookies WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Çerezler Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Çerezler Sayfası İçerik Düzenleme</h3>
</div>
