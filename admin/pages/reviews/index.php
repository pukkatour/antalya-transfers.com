...
$data    = $Db->row("SELECT * FROM page_reviews WHERE page_lang_id = ?", array($lang_id));
...
<li class="active">Yorumlar Sayfası</li>
</ol>
</section>
...
<div class="box-header with-border">
<h3 class="box-title">Yorumlar Sayfası İçerik Düzenleme</h3>
</div>
