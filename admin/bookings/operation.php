...
$Db->query("UPDATE transfer_bookings SET booking_status = ? WHERE booking_id = ?", array($action,$id));
...
$emailbodytitle = $trans_form['tr_f_0090']." ".$trans_form['tr_f_0091'];
...
$address = $booking_email;
$mail->AddAddress($address);
$mail->send();
$mail->ClearAllRecipients();

///
$sms_receiver_phone = substr($cod.$booking_phone, 1);
$sms_receiver_phone = "00".$sms_receiver_phone;
$sms_text2          = $trans_form['tr_f_0090'];
...
$emailbodytitle = $trans_form['tr_f_0064']." ".$booking_name." ".$booking_surname;
$subject        = $booking_code." - ".$t_type." - ".$airport_name." - ".$resort_name;

$emailbodytext  = $trans_form['tr_f_0092'];
...
$emailbodytitle = $trans_form['tr_f_0064']."<br><br>".$trans_form['tr_f_0093'];
$subject        = $booking_code." - ".$t_type." - ".$airport_name." - ".$resort_name;
...
$_SESSION["alert"] = "ok";
redirect(SITE_URL."admin/bookings/index.php?status=$action");
