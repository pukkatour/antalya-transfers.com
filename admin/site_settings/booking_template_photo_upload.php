...
$foo->image_x = $photo_w;
$foo->image_y = $photo_h;
$foo->Process(IMAGE_PATH."email_booking/");
}
if ($foo->processed) {
$Db->query("UPDATE booking_template SET $photo_type = ?", array($img_db));

$_SESSION["alert"] = "ok";
redirect(SITE_URL."admin/site_settings/booking_template.php?lang_id=$lang_id"); exit;
}
