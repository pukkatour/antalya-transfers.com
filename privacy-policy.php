...
$data = $Db->row("SELECT * FROM page_privacy WHERE page_lang_id = ?", array($site_lang));
...
<link rel="alternate" href="<?php echo SITE_URL; ?>tr/gizlilik-politikasi" hreflang="tr-TR" />
